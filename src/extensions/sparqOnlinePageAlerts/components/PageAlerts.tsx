...
import { QUALIFIED_NAME } from '../SparqOnlinePageAlertsApplicationCustomizer';


interface IPageAlertItem {
    ID: number;
    Title: string;
    Announcement: string;
    Urgent: boolean;
...
export default function RenderPageAlerts(props: IPageAlertProps) {
    // Two local state variables with their setter
    let [announcements, setAnnouncements] = useState<IPageAlertItem[]>([]);
